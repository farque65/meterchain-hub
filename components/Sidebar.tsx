export default function Sidebar() {
  return (
    <aside
      id="default-sidebar"
      className="fixed left-0 top-0 h-full w-64 transition-transform sm:translate-x-0"
      aria-label="Sidebar"
    >
        ...
        <ul className="space-y-2 font-medium">
          <li>
            ...
            >
              ...
              <span className="ms-3">Meter Chain Hub</span>
            </a>
          </li>
          <li>
            <a
          ...
          <li>
            ...
            >
              ...
              <span className="ms-3 flex-1 whitespace-nowrap">Earn XP</span>
          ...
          <li>
            ...
            >
              ...
              <span className="ms-3 flex-1 whitespace-nowrap">Transactions</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="ms-3 flex-1 whitespace-nowrap">Holdings</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span className="ms-3 flex-1 whitespace-nowrap">Send</span>
            </a>
          </li>
          <li>
            <a
